    ...
    $.fn.amsifySuggestags = function(options, method) {
        ...
        AmsifySuggestags.prototype = {
            ...
            createHTML : function() {
              ...
              var labelHTML                 = '<div class="d-inline-block flex-row col-12 '+this.classes.inputArea.substring(1)+'"></div>';
              ...
              var listArea              = '<div class="w-auto '+this.classes.listArea.substring(1)+'"></div>';
