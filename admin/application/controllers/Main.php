...
class Main extends MX_Controller {
	...
	public function logout()
	{
		...
		$this->utils->RemovequeueDoctor($user_id);
		redirect("member","refresh");
	}
	public function test()
	{	
		$main_item_id = $this->session->userdata('main_item_id');
		$related_item_id = $this->session->userdata('related_item_id');
		echo 'main_item_id   || ';
		print_r($main_item_id);
		echo '<br>related_item_id  || ';
		print_r($related_item_id);
	}
}
