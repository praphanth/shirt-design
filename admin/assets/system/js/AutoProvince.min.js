...
;(function( $ ){
	$.fn.AutoProvince = function( options ) {
		...
		return this.each(function() {
			...
			var provinceUrl = "json/provinces.json";
			var amphureUrl = "json/amphures.json";
			var districtUrl = "json/districts.json";
			var zipcodeUrl = "json/zipcodes.json";
			var geographyUrl = "json/geography.json";
