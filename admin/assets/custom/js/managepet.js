...
function fixExifOrientation(idimage,$img) {
    EXIF.getData($img, function() {
        ...
        idimage.removeClass();
        idimage.addClass('img-circle');
        switch(parseInt(EXIF.getTag(this, "Orientation"))) {
            case 2:
                idimage.removeClass();
                idimage.addClass('img-circle flip'); break;
            case 3:
                idimage.removeClass();
                idimage.addClass('img-circle rotate-180'); break;
            case 4:
                idimage.removeClass();
                idimage.addClass('img-circle flip-and-rotate-180'); break;
            case 5:
                idimage.removeClass();
                idimage.addClass('img-circle flip-and-rotate-270'); break;
            case 6:
                idimage.removeClass();
                idimage.addClass('img-circle rotate-90'); break;
            case 7:
                idimage.removeClass();
                idimage.addClass('img-circle flip-and-rotate-90'); break;
            case 8:
                idimage.removeClass();
                idimage.addClass('img-circle rotate-270'); break;
        }
    });
}
...
function addPet() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var imagepetedit = document.getElementById('imagepet1');
            var pets = $('#pets');
                                ...
                                '<div class="card-body">'+
                                    '<div class="row">'+
                                        '<div class="col-md-3 petimg">'+
                                            '<img id="imagepetAdd'+npet+'" class="img-circle timagepet" src="'+clonimg+'" width="100" height="100">'+
                                        '</div>'+
            ...
            $('#imagepetAdd'+npet).removeClass();
            $('#imagepetAdd'+npet).addClass(imagepetedit.className);
            $('#my_file').val('');
            $('#petname').val(''); 
...
function addPetIsCuid() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#imagepetAdd'+pet_id).removeClass();
            $('#imagepetAdd'+pet_id).addClass(imagepetedit.className);
            console.log(imagepetedit.className);
            $('#my_file').val('');
            $('#petname').val(''); 
            $('#pettype').prop('selectedIndex', 0);
            $('#petsex').prop('selectedIndex', 0);
...
function editPet(npet){
    ...
    $("#modalEditpet").on("shown.bs.modal", function () {
        var imagepet = document.getElementById('imagepetAdd'+npet);
        var imagepetedit = document.getElementById('imagepetedit');
        $('#imagepetedit').removeClass();
        $('#imagepetedit').addClass(imagepet.className);
        ...
        $.ajax({
            ...
            success: function (data) { 
                ...
                $("#modalEditpet").on("show.bs.modal", function () {
                    ...
                    var editpettype = document.getElementById('editpettype');
                    editpettype.value = data.pettype;
                    ...
                    var imagepet = document.getElementById('imagepetAdd'+pet_id);
...
function updatePetIsCuid(){
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var imageedit = document.getElementById('imagepetedit'); //edits
            console.log(imageedit);
            $('#imagepetAdd'+editid).removeClass();
            $('#imagepetAdd'+editid).addClass(imageedit.className);
            ...
            swal('ข้อความจากระบบ','บันทึกข้อมูลเรียบร้อยแล้ว');
        }
    });
}
