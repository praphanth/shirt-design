...
function checkAlertCategory(){
    ...
    if(Mycategory1.innerHTML.trim() == ''){
        $('#category-1').append('<div id="alert-category-1" class="col-12 mt-2">'+
            '<div class="row">'+
                '<div class="col-12 col-md-8 col-lg-9 align-self-center">'+
                   'ยังไม่มีรายการตรวจ สั่งจ่ายยา (Rx) คลิก "เพิ่มรายการ" ค้นหา และเพิ่มรายการ สั่งจ่ายยา (Rx) ที่ต้องการตรวจ'+
                '</div>'+
    ...
    if(Mycategory2.innerHTML.trim() == ''){
        $('#category-2').append('<div id="alert-category-2" class="col-12 mt-2">'+
            '<div class="row">'+
                '<div class="col-12 col-md-8 col-lg-9 align-self-center">'+
                   'ยังไม่มีรายการตรวจ รายการตรวจรักษา (Tx) คลิก "เพิ่มรายการ" ค้นหา และเพิ่มรายการ รายการตรวจรักษา (Tx) ที่ต้องการตรวจ'+
                '</div>'+
                '<div class="col-12 col-md-4 col-lg-3"></div>'+
        '</div>');
    }
    if(Mycategory2.innerHTML.trim() == ''){
        $('#category-2').append('<div id="alert-category-3" class="col-12 mt-2">'+
            '<div class="row">'+
                '<div class="col-12 col-md-8 col-lg-9 align-self-center">'+
                   'ยังไม่มีรายการตรวจ สินค้า/สิ่งของ/อุปกรณ์ คลิก "เพิ่มรายการ" ค้นหา และเพิ่มรายการ สินค้า/สิ่งของ/อุปกรณ์ ที่ต้องการตรวจ'+
                '</div>'+
                '<div class="col-12 col-md-4 col-lg-3"></div>'+
        '</div>');
    }
     if(Mycategory4.innerHTML.trim() == ''){
        $('#category-4').append('<div id="alert-category-4" class="col-12 mt-2">'+
            '<div class="row">'+
                '<div class="col-12 col-md-8 col-lg-9 align-self-center">'+
                   'ยังไม่มีรายการตรวจ รายการอื่นๆ คลิก "เพิ่มรายการ" ค้นหา และเพิ่มรายการ รายการอื่นๆ ที่ต้องการตรวจ'+
                '</div>'+
                '<div class="col-12 col-md-4 col-lg-3"></div>'+
        '</div>');
    }
     if(Mycategory5.innerHTML.trim() == ''){
        $('#category-5').append('<div id="alert-category-5" class="col-12 mt-2">'+
            '<div class="row">'+
                '<div class="col-12 col-md-8 col-lg-9 align-self-center">'+
                   'ยังไม่มีรายการตรวจ '+lab+' คลิก "เพิ่มรายการ" ค้นหา และเพิ่มรายการ '+lab+' ที่ต้องการตรวจ'+
                '</div>'+
                '<div class="col-12 col-md-4 col-lg-3"></div>'+
        '</div>');
    }
