...
var reportConfig = {
	report_url:config.base_url+"report/api/report_api/getOrderProduct",
...
function filteringOption(){
	...
	console.log('stock_status = ' + stock_status + ':' + 'endDate = ' + stock_status);
...
function loadReport(filtering){
	...
	$.ajax({
		...
		success: function(json){
			...
			{
				deposit += parseInt(json.data[i][9]);
