...
function sendFinance() {
  el('grooming_form').action = 'save/finance';
  el('grooming_form').submit();
}var addItemConfig = {
...
var itemUrl = {
    stock_url:config.base_url+"grooming/api/grooming_api/getStock",
    modeldrug_url:config.base_url+"grooming/api/grooming_modal/model_list_drug",
    modelother_url:config.base_url+"grooming/api/grooming_modal/model_list_other",
    editmodeldrug_url:config.base_url+"grooming/api/grooming_modal/edit_model_list_drug",
    editmodelother_url:config.base_url+"grooming/api/grooming_modal/edit_model_list_other",
    editmodelRelateddrug_url:config.base_url+"grooming/api/grooming_modal/edit_model_related_list_drug",
    saleitem_url:config.base_url+'grooming/api/grooming_api/saleitem',
    addpricing_url:config.base_url+'grooming/api/grooming_api/',
}
